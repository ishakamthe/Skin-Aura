...
import { MOCK_PRODUCTS, MOCK_ALTERNATIVES } from "@/data/mockProducts";
...
const ProductDetail = () => {
  ...
  const alternatives = MOCK_ALTERNATIVES.filter((a) => a.id !== product.id).slice(0, 3);
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
      ...
      <motion.div
                ...
                <motion.div
                  ...
                  className="flex items-center justify-between p-4 card-skin-hover">
                    ...
                    <div className="flex items-center gap-4">
                      <div className={`w-3 h-3 rounded-full shrink-0 ${hazardDot[ing.safety]}`} />
                      <div>
        ...
        <section className="mt-16">
            <h3 className="text-2xl font-bold mb-6">Safer Alternatives in This Category</h3>
            ...
            <motion.div
              ...
              className="card-skin-hover p-5 cursor-pointer group">
                  ...
                  <div className="w-full aspect-[4/3] bg-muted rounded-2xl overflow-hidden mb-4 flex items-center justify-center p-4">
                    <img src={alt.image} alt={alt.name} className="max-h-full object-contain mix-blend-multiply" />
                  </div>
                  <div className="mb-3 p-3 bg-muted/40 rounded-xl">
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-1">About this product</p>
                    <p className="text-xs text-foreground leading-relaxed line-clamp-3">{alt.description}</p>
                  </div>
