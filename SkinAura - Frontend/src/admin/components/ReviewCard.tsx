        ...
        <div className="flex gap-2 shrink-0">
          {[frontUrl, backUrl].map((url, i) =>
            url ? (
              ...
              <div key={i} className="w-16 h-16 rounded-xl border border-border bg-surface-2 flex items-center justify-center">
      ...
      <div className="p-5 space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2 max-h-64 overflow-y-auto pr-1">
            {ingredients.map((ing, idx) =>
              editing ? (
                <div key={idx} className="flex items-center gap-2 bg-surface-2 rounded-xl p-2 border border-border">
                ...
                <div key={idx} className="flex items-center justify-between px-3 py-2 bg-surface-2 rounded-xl border border-border">
        ...
        {product.raw_text && (
          <div>
            ...
            {showRawText && (
              <pre className="mt-3 p-4 bg-surface-2 border border-border rounded-2xl text-xs text-text-3 font-mono whitespace-pre-wrap overflow-auto max-h-64">
                {product.raw_text}
              </pre>
            )}
          </div>
